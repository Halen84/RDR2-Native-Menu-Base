...
void DrawListOption(std::string text, int index)
{
	...
	if (selectedIndex <= 7 && index <= 7) {
		...
		DrawCSSText(text, Font::Hapna, 0xff, 0xff, 0xff, 0xff, Alignment::Left, 22, 105, 254 + (index * INCREMENT));
		...
		DrawCSSText(text, Font::Hapna, 0xff, 0xff, 0xff, 0xff, Alignment::Left, 22, 105, 254 + ((index - (selectedIndex - 7)) * INCREMENT));
	}
}
...
void DrawSelectionBox()
{
	...
	if (index >= 7) {
		DrawSprite("menu_textures", "crafting_highlight_l",  96, 270 + (7 * INCREMENT), 19 , 57 , 0, 255, 0, 0, 255, true);
		DrawSprite("menu_textures", "crafting_highlight_r", 518, 270 + (7 * INCREMENT), 19 , 57 , 0, 255, 0, 0, 255, true);
		...
		DrawSprite("menu_textures", "crafting_highlight_l",  96, 270 + (index * INCREMENT), 19 , 57, 0, 255, 0, 0, 255, true);
		DrawSprite("menu_textures", "crafting_highlight_r", 518, 270 + (index * INCREMENT), 19 , 57, 0, 255, 0, 0, 255, true);
...
void SetSubHeader(std::string text) {
	DrawCSSText(text, Font::Lino, 0xff, 0xff, 0xff, 0xff, Alignment::Center, 23, BG_X_OFFSET + (BG_WIDTH * 0.5f), 80 + 90);
}
